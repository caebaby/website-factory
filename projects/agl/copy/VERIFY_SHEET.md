...
|---|---|---|---|---|
| 1 | **Booking URL** (Calendly/SavvyCal/GHL) | Guide-card CTA on home (`data-verify="booking-url"`); LED-018 says the LIVE preview still has 3 dead CTAs — redeploy needs this | The link | CTA declared pending; gauntlet treats as P1 non-blocking |
