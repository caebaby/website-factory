...
**2026-08-02 business-hero full-bleed correction (same branch, local only):** removed the active blurred-fill phone derivative from the selected Vlada Karpovich boardroom hero. The same 16:9 source now renders edge to edge at every breakpoint with `object-fit: cover`; narrow screens crop the outer meeting participants instead of showing artificial bands. Source history remains documented for rollback. Fresh gate: homepage **0 P0 / 2 pre-existing review-copy P1 / 0 P2**; comparison page **0 P0 / 0 P1 / 1 accepted restrained-accent P2**. Desktop and 390px Tier-B passed with no bands. Public GitHub review remains unchanged.
