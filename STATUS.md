...
Last updated: 2026-08-03 (Anchor's mobile family hero now uses a borderless 9:16 cover derivative; Alex's copy changes, audience reorder, and audience-card crops remain on the isolated Anchor branch. The existing public nine-route review is unchanged. Read the ANCHOR block first, then FINISH LINE). **2026-07-23: branches merged — this file now carries the Anchor line, the AGL pilot line (see AGL PILOT SESSION block), and the Codex Anchor iterations in one history.**
