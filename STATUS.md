...
Last updated: 2026-07-16 (Anchor v6 expanded into connected site system — read the ANCHOR block first, then FINISH LINE). Prior: 2026-07-13 v6 review candidate.
...
**Live review:** `build/home-v6.html` · public link `caebaby.github.io/anchor-review/` · local server on :8200. Prior builds remain as history: v5 = GLM 5.2 via Hermes; v4 = Codex (visible `CODEX DESIGN` marker + `data-design-builder="codex"` provenance metadata); v3 = earlier clean print.
