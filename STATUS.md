...
Last updated: 2026-08-03 (Alex's returned copy changes and audience reorder are being finalized on the isolated Anchor branch; the existing public nine-route review remains unchanged. Read the ANCHOR block first, then FINISH LINE). **2026-07-23: branches merged — this file now carries the Anchor line, the AGL pilot line (see AGL PILOT SESSION block), and the Codex Anchor iterations in one history.**
