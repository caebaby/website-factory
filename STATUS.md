...
Last updated: 2026-08-02 (Anchor hero-media refresh is on an isolated local review branch; the existing public nine-route review remains unchanged. Read the ANCHOR block first, then FINISH LINE). **2026-07-23: branches merged — this file now carries the Anchor line, the AGL pilot line (see AGL PILOT SESSION block), and the Codex Anchor iterations in one history.**
