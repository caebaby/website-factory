...
Last updated: 2026-08-03 (Anchor's nine-route local review now includes a consistent Client Login path to Investor360 in every header/mobile menu and footer; current design/copy/media revisions remain on the isolated Anchor branch. The public review is unchanged. Read the ANCHOR block first, then FINISH LINE). **2026-07-23: branches merged — this file now carries the Anchor line, the AGL pilot line (see AGL PILOT SESSION block), and the Codex Anchor iterations in one history.**
