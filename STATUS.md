...
Last updated: 2026-08-03 (Anchor's Alex-copy release is public and the verified nine-route static Replit handoff is at `projects/awp/handoff/`. Review-mode crawler controls stay locked until production-domain and compliance approval. Read the ANCHOR block first, then FINISH LINE). **2026-07-23: branches merged — this file now carries the Anchor line, the AGL pilot line (see AGL PILOT SESSION block), and the Codex Anchor iterations in one history.**
